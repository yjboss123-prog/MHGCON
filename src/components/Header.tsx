...
export const Header = memo(function Header({ currentRole, onAddTask, onRebaseline, onProjectSettings, onInvite, onAdminPanel, language, onLanguageChange, projectName, projectDescription, userSession, onSignOut, onSwitchCode, viewMode = 'list', onViewModeChange }: HeaderProps) {
